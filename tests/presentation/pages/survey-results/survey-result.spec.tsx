...
import { mockAccountModel, LoadSurveyResultSpy, SaveSurveyResultSpy, mockSurveyResultModel } from '@/tests/domain/mocks'
...
describe('SurveyResult Component', () => {
  ...
  test('Should call LoadSurveyList on failure', async () => {
    const loadSurveyResultSpy = new LoadSurveyResultSpy()
  ...
  test('Should present SurveyResult data on save survey result success', async () => {
    const saveSurveyResultSpy = new SaveSurveyResultSpy()
    const surveyResult = mockSurveyResultModel()
    surveyResult.date = new Date('2020-01-20T00:00:00')
  ...
  test('Should prevents multiple answer click', async () => {
    ...
    fireEvent.click(answersWrap[1])
    await waitFor(() => screen.getByTestId('survey-result'))
    expect(saveSurveyResultSpy.callCount).toBe(1)
  })
})
